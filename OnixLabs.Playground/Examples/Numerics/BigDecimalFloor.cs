...
[Title("BigDecimal.Floor vs Math.Floor")]
public sealed class BigDecimalFloor : Example
{
    public override void Execute()
    {
        ...
        {
            decimal expected = Math.Floor(value);
            BigDecimal actual = BigDecimal.Floor(new BigDecimal(value));
            ...
            string[] table =
            {
                $"BigDecimal.Floor({value})".PadRight(32),
