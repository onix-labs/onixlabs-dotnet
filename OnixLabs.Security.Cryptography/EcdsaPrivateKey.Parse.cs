...
{
    /// <summary>
    /// Parses the specified <see cref="String"/> value into a <see cref="EcdsaPrivateKey"/> value.
    /// </summary>
    /// <param name="value">The value to parse.</param>
    /// <param name="provider">The format provider that will be used to decode the specified value.</param>
    /// <returns>Returns a new <see cref="EcdsaPrivateKey"/> instance, parsed from the specified <see cref="String"/> value.</returns>
    ...
    /// <summary>
    /// Tries to parse the specified <see cref="String"/> value into a <see cref="EcdsaPrivateKey"/> value.
    /// </summary>
    /// <param name="value">The value to parse.</param>
    /// <param name="provider">The format provider that will be used to decode the specified value.</param>
    /// <param name="result">
    /// A new <see cref="EcdsaPrivateKey"/> instance, parsed from the specified <see cref="String"/> value, or the default
    /// <see cref="EcdsaPrivateKey"/> value if the specified <see cref="String"/> could not be parsed.
    /// </param>
    ...
    public static bool TryParse(ReadOnlySpan<char> value, IFormatProvider? provider, out EcdsaPrivateKey result)
    {
        ...
        result = new EcdsaPrivateKey(bytes);
        return isDecoded;
    }
}
