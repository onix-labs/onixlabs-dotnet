...
public readonly partial struct Int256
{
    ...
    public static bool IsZero(Int256 value) => value.UpperBits == UInt128.Zero && value.LowerBits == UInt128.Zero;
    ...
    public static bool IsNegative(Int256 value) => (value.UpperBits & SignBitMask) != UInt128.Zero;
    ...
    public static bool IsPositive(Int256 value) => (value.UpperBits & SignBitMask) == UInt128.Zero;
    ...
    public static bool IsEvenInteger(Int256 value) => (value.LowerBits & UInt128.One) == UInt128.Zero;
    ...
    public static bool IsOddInteger(Int256 value) => (value.LowerBits & UInt128.One) != UInt128.Zero;
