...
public readonly partial struct Float128
{
    ...
    /// </summary>
    /// <returns>Returns the enumerated constant that represents the <see cref="TypeCode"/> of this implementation.</returns>
    ...
    /// </summary>
    /// <param name="provider">An <see cref="IFormatProvider"/> implementation that supplies culture-specific formatting information.</param>
    ...
    /// <exception cref="InvalidCastException">Always thrown; <see cref="Float128"/> cannot be converted to a <see cref="DateTime"/>.</exception>
    DateTime IConvertible.ToDateTime(IFormatProvider? provider) => throw new InvalidCastException($"Cannot convert {nameof(Float128)} to {nameof(DateTime)}.");
    ...
    /// </summary>
    /// <param name="provider">An <see cref="IFormatProvider"/> implementation that supplies culture-specific formatting information.</param>
    /// <returns>Returns <see langword="false"/> when the value is zero; otherwise <see langword="true"/>.</returns>
    ...
    /// <param name="provider">An <see cref="IFormatProvider"/> implementation that supplies culture-specific formatting information.</param>
    /// <returns>Returns an <see cref="object"/> instance of the specified type whose value is equivalent to the value of this instance.</returns>
