...
public readonly partial struct Volume<T> : IUnit<Volume<T>> where T : IFloatingPoint<T>
#pragma warning restore CA2231
{
    ...
    /// <summary>
    /// Gets the volume in Cubic Micrometers (um³).
    /// </summary>
    ...
    /// <summary>
    /// Gets the volume in US Fluid Ounces (US floz).
    /// </summary>
    ...
    /// <summary>
    /// Gets the volume in Imperial Fluid Ounces (imp floz).
    /// </summary>
