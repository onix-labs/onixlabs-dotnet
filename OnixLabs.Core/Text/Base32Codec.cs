...
public sealed class Base32Codec : IBaseCodec
{
    ...
    /// <summary>
    /// Encodes the specified <see cref="System.ReadOnlySpan{T}"/> value into a Base-32 <see cref="System.String"/> representation.
    /// </summary>
    /// <param name="value">The value to encode into a Base-32 <see cref="System.String"/> representation.</param>
    /// <param name="provider">The format provider that will be used to encode the specified value.</param>
    /// <returns>Returns a new Base-32 <see cref="System.String"/> representation encoded from the specified value.</returns>
    ...
    /// <summary>
    /// Decodes the specified <see cref="System.ReadOnlySpan{T}"/> Base-32 representation into a <see cref="T:System.Byte[]"/>.
    /// </summary>
    /// <param name="value">The Base-32 value to decode into a <see cref="T:System.Byte[]"/>.</param>
    /// <param name="provider">The format provider that will be used to encode the specified value.</param>
    ...
    /// <summary>
    /// Attempts to encode the specified <see cref="System.ReadOnlySpan{T}"/> value into a Base-32 <see cref="System.String"/> representation.
    /// </summary>
    /// <param name="value">The value to encode into a Base-32 <see cref="System.String"/> representation.</param>
    /// <param name="provider">The format provider that will be used to encode the specified value.</param>
    /// <param name="result">
    /// A new Base-32 <see cref="System.String"/> representation encoded from the specified value,
    ...
    /// <summary>
    /// Attempts to decode the specified <see cref="System.ReadOnlySpan{T}"/> Base-32 representation into a <see cref="T:System.Byte[]"/>.
    /// </summary>
    /// <param name="value">The Base-32 value to decode into a <see cref="T:System.Byte[]"/>.</param>
    /// <param name="provider">The format provider that will be used to encode the specified value.</param>
    /// <param name="result">
