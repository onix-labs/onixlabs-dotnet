...
{
    /// <summary>
    /// The default ordinal comparer for comparing <see cref="BigDecimal"/> values.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the <paramref name="left"/> <see cref="BigDecimal"/> value is equal to the <paramref name="right"/> <see cref="BigDecimal"/> value.
    /// </summary>
    ...
    /// <returns>Returns <see langword="true"/> if the <paramref name="left"/> <see cref="BigDecimal"/> value is equal to the <paramref name="right"/> <see cref="BigDecimal"/> value; otherwise, <see langword="false"/>.</returns>
    public bool IsEqual(BigDecimal left, BigDecimal right) => Compare(left, right) is 0;

    /// <summary>
    /// Determines whether the <paramref name="left"/> <see cref="BigDecimal"/> value is greater than the <paramref name="right"/> <see cref="BigDecimal"/> value.
    /// </summary>
    /// <param name="left">The <paramref name="left"/> <see cref="BigDecimal"/> value to compare.</param>
    /// <param name="right">The <paramref name="right"/> <see cref="BigDecimal"/> value to compare.</param>
