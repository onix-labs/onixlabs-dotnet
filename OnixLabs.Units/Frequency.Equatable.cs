...
{
    /// <inheritdoc/>
    public static bool Equals(Frequency<T> left, Frequency<T> right) => left.QuectoHertz == right.QuectoHertz;
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(QuectoHertz);
}
