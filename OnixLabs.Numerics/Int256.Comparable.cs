...
{
    /// <summary>Compares two <see cref="Int256"/> values and returns an integer that indicates their relative order, using signed semantics.</summary>
    ...
    /// <exception cref="ArgumentException">Thrown when <paramref name="obj"/> is not <see langword="null"/> and not an <see cref="Int256"/>.</exception>
    ...
    /// <summary>Compares the current instance with another <see cref="Int256"/> value.</summary>
    /// <param name="other">An <see cref="Int256"/> value to compare with this instance.</param>
    /// <returns>Returns a negative integer, zero, or a positive integer indicating the relative order.</returns>
    public int CompareTo(Int256 other) => Compare(this, other);
    ...
    public static bool operator <(Int256 left, Int256 right) => Compare(left, right) < 0;
