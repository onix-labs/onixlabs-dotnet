...
{
    /// <inheritdoc/>
    public static EcdsaPrivateKey Parse(string value, IFormatProvider? provider = null) =>
        Parse(value.AsSpan(), provider);

    /// <inheritdoc/>
    public static EcdsaPrivateKey Parse(ReadOnlySpan<char> value, IFormatProvider? provider = null) =>
        EcdsaPrivateKey.ParseOrThrow(value, provider);

    /// <inheritdoc/>
    public static bool TryParse(string? value, IFormatProvider? provider, out EcdsaPrivateKey result) =>
