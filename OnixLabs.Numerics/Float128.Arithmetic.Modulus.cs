...
public readonly partial struct Float128
{
    ...
    internal static Float128 ClearSign(in Float128 value) => new(value.Bits & ~SignMask);
    ...
    /// </remarks>
    private static Float128 ReduceModulo(in Float128 absLeft, in Float128 modulus)
    {
