...
public static partial class DataSize
{
    ...
    public static DataSize<T> FromBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromBits(value);
    }
    ...
    public static DataSize<T> FromNibbles<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromNibbles(value);
    }
    ...
    public static DataSize<T> FromBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromBytes(value);
    }
    ...
    public static DataSize<T> FromWords<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromWords(value);
    }
    ...
    public static DataSize<T> FromDoubleWords<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromDoubleWords(value);
    }
    ...
    public static DataSize<T> FromQuadWords<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromQuadWords(value);
    }
    ...
    public static DataSize<T> FromKiloBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromKiloBits(value);
    }
    ...
    public static DataSize<T> FromKibiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromKibiBits(value);
    }
    ...
    public static DataSize<T> FromKiloBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromKiloBytes(value);
    }
    ...
    public static DataSize<T> FromKibiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromKibiBytes(value);
    }
    ...
    public static DataSize<T> FromMegaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromMegaBits(value);
    }
    ...
    public static DataSize<T> FromMebiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromMebiBits(value);
    }
    ...
    public static DataSize<T> FromMegaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromMegaBytes(value);
    }
    ...
    public static DataSize<T> FromMebiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromMebiBytes(value);
    }
    ...
    public static DataSize<T> FromGigaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromGigaBits(value);
    }
    ...
    public static DataSize<T> FromGibiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromGibiBits(value);
    }
    ...
    public static DataSize<T> FromGigaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromGigaBytes(value);
    }
    ...
    public static DataSize<T> FromGibiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromGibiBytes(value);
    }
    ...
    public static DataSize<T> FromTeraBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromTeraBits(value);
    }
    ...
    public static DataSize<T> FromTebiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromTebiBits(value);
    }
    ...
    public static DataSize<T> FromTeraBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromTeraBytes(value);
    }
    ...
    public static DataSize<T> FromTebiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromTebiBytes(value);
    }
    ...
    public static DataSize<T> FromPetaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromPetaBits(value);
    }
    ...
    public static DataSize<T> FromPebiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromPebiBits(value);
    }
    ...
    public static DataSize<T> FromPetaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromPetaBytes(value);
    }
    ...
    public static DataSize<T> FromPebiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromPebiBytes(value);
    }
    ...
    public static DataSize<T> FromExaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromExaBits(value);
    }
    ...
    public static DataSize<T> FromExbiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromExbiBits(value);
    }
    ...
    public static DataSize<T> FromExaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromExaBytes(value);
    }
    ...
    public static DataSize<T> FromExbiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromExbiBytes(value);
    }
    ...
    public static DataSize<T> FromZettaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromZettaBits(value);
    }
    ...
    public static DataSize<T> FromZebiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromZebiBits(value);
    }
    ...
    public static DataSize<T> FromZettaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromZettaBytes(value);
    }
    ...
    public static DataSize<T> FromZebiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromZebiBytes(value);
    }
    ...
    public static DataSize<T> FromYottaBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromYottaBits(value);
    }
    ...
    public static DataSize<T> FromYobiBits<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromYobiBits(value);
    }
    ...
    public static DataSize<T> FromYottaBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromYottaBytes(value);
    }
    ...
    public static DataSize<T> FromYobiBytes<T>(T value) where T : IFloatingPoint<T>
    {
        return DataSize<T>.FromYobiBytes(value);
    }
}
