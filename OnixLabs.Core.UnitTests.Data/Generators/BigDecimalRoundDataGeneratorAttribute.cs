...
public sealed class BigDecimalRoundDataGeneratorAttribute : DataAttribute
{
    ...
    public BigDecimalRoundDataGeneratorAttribute(int start, int end, int skip, int scale)
    {
