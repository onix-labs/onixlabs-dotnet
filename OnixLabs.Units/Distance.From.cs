...
public readonly partial struct Distance<T>
{
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromRontometers(T value) => new(value.FromRontoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromYoctometers(T value) => new(value.FromYoctoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromZeptometers(T value) => new(value.FromZeptoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromAttometers(T value) => new(value.FromAttoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromFemtometers(T value) => new(value.FromFemtoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromPicometers(T value) => new(value.FromPicoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromNanometers(T value) => new(value.FromNanoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromMicrometers(T value) => new(value.FromMicroUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromMillimeters(T value) => new(value.FromMilliUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromCentimeters(T value) => new(value.FromCentiUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromDecimeters(T value) => new(value.FromDeciUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromMeters(T value) => new(value.FromBaseUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromDecameters(T value) => new(value.FromDecaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromHectometers(T value) => new(value.FromHectoUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromMegameters(T value) => new(value.FromMegaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromGigameters(T value) => new(value.FromGigaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromTerameters(T value) => new(value.FromTeraUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromPetameters(T value) => new(value.FromPetaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromExameters(T value) => new(value.FromExaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromZettameters(T value) => new(value.FromZettaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromYottameters(T value) => new(value.FromYottaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromRonnameters(T value) => new(value.FromRonnaUnits());
    ...
    /// <param name="value">The value from which to construct the new <see cref="Distance{T}"/> instance.</param>
    /// <returns>Returns a new <see cref="Distance{T}"/> instance from the specified value.</returns>
    public static Distance<T> FromQuettameters(T value) => new(value.FromQuettaUnits());
