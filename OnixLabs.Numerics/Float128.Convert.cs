...
public readonly partial struct Float128
{
    ...
    /// <summary>
    /// Attempts to convert the specified value of type <typeparamref name="TOther"/> into a <see cref="Float128"/> using the supported numeric conversions.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to convert the specified <see cref="Float128"/> value into the requested numeric type <typeparamref name="TOther"/> using the supported numeric conversions.
    /// </summary>
