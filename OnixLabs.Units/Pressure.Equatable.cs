...
{
    /// <inheritdoc/>
    public static bool Equals(Pressure<T> left, Pressure<T> right) => left.QuectoPascals == right.QuectoPascals;
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(QuectoPascals);
}
