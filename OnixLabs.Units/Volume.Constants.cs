...
public readonly partial struct Volume<T>
{
    ...
    private static readonly T CuQuectometersPerCubicInch = T.CreateChecked(16387064) * UnitMath.Pow10<T>(78); // 0.0254³ m³
    private static readonly T CuQuectometersPerCubicFoot = T.CreateChecked(28316846592L) * UnitMath.Pow10<T>(78); // 0.3048³ m³
    private static readonly T CuQuectometersPerCubicYard = T.CreateChecked(764554857984L) * UnitMath.Pow10<T>(78); // 0.9144³ m³
    private static readonly T CuQuectometersPerCubicMile = T.CreateChecked(4168181825440579584L) * UnitMath.Pow10<T>(81); // 1 609.344³ m³
    ...
    private static readonly T CuQuectometersPerCubicAstronomicalUnit =
        T.CreateChecked(149_597_870_700L) * T.CreateChecked(149_597_870_700L) * T.CreateChecked(149_597_870_700L) * UnitMath.Pow10<T>(90); // AU³ m³

    private static readonly T CuQuectometersPerCubicLightYear =
        T.CreateChecked(9_460_730_472_580_800L) * T.CreateChecked(9_460_730_472_580_800L) * T.CreateChecked(9_460_730_472_580_800L) * UnitMath.Pow10<T>(90); // (365.25 d × c)³ m³
    ...
    private static readonly T CuQuectometersPerImperialFluidOunce = T.CreateChecked(284130625) * UnitMath.Pow10<T>(77); // imp pt / 20
    private static readonly T CuQuectometersPerOilBarrel = T.CreateChecked(158987294928L) * UnitMath.Pow10<T>(78); // 42 US gal
