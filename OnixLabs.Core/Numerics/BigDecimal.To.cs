...
public readonly partial struct BigDecimal
{
    ...
    public byte[] ToByteArray()
    {
        ...
        byte[] precision = BitConverter.GetBytes(Scale);

        return unscaledValue.ConcatenateWith(precision);
    }
    ...
    public override string ToString()
    {
        ...
        string fractionalValue = AbsoluteFractionalValue.ToString().PadLeft(Scale, '0');
