...
public readonly partial struct Int256
{
    ...
    public static Int256 operator &(Int256 left, Int256 right) => new(left.UpperBits & right.UpperBits, left.LowerBits & right.LowerBits);
    ...
    public static Int256 operator ~(Int256 value) => new(~value.UpperBits, ~value.LowerBits);
}
