...
/// <summary>
/// Provides extension methods for <see cref="IAdditiveUnit{T}"/> instances.
/// </summary>
[EditorBrowsable(EditorBrowsableState.Never)]
public static class IAdditiveUnitExtensions
{
    /// <summary>
    /// Provides additive operator overloads for <see cref="IAdditiveUnit{T}"/> instances.
    /// </summary>
    /// <typeparam name="T">The underlying type of the <see cref="IAdditiveUnit{T}"/> instance.</typeparam>
    extension<T>(T) where T : struct, IAdditiveUnit<T>
    {
        /// <summary>
    ...
    /// <summary>
    /// Provides instance additive methods for <see cref="IAdditiveUnit{T}"/> instances.
    /// </summary>
    /// <param name="left">The left-hand value of the additive operation.</param>
    /// <typeparam name="T">The underlying type of the <see cref="IAdditiveUnit{T}"/> instance.</typeparam>
    extension<T>(T left) where T : struct, IAdditiveUnit<T>
    {
        /// <summary>
