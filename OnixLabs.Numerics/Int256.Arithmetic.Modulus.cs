...
{
    /// <summary>Computes the remainder of two <see cref="Int256"/> values, following C# integer modulus rules (sign of dividend).</summary>
    ...
    public static Int256 operator %(Int256 left, Int256 right)
    {
        ...
        (_, Int256 remainder) = DivRem(left, right);
        return remainder;
    }
}
