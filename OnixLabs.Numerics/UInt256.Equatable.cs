...
{
    /// <summary>
    /// Compares two instances of <see cref="UInt256"/> to determine whether their values are equal.
    /// </summary>
    ...
    public static bool Equals(UInt256 left, UInt256 right) => left.UpperBits == right.UpperBits && left.LowerBits == right.LowerBits;

    /// <summary>
    /// Compares the current instance of <see cref="UInt256"/> with the specified other instance of <see cref="UInt256"/>.
    /// </summary>
    /// <param name="other">The other instance of <see cref="UInt256"/> to compare with the current instance.</param>
    ...
    public bool Equals(UInt256 other) => Equals(this, other);
    ...
    public static bool operator ==(UInt256 left, UInt256 right) => Equals(left, right);
