...
public readonly partial struct Base58
{
    ...
    /// <summary>
    /// Create a new <see cref="Base58"/> instance from the specified <see cref="byte"/> array value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="Base58"/> instance.</param>
    /// <returns>Returns a new <see cref="Base58"/> instance from the specified <see cref="byte"/> array value.</returns>
    ...
    /// <summary>
    /// Create a new <see cref="Base58"/> instance from the specified <see cref="char"/> array value.
    /// <remarks>The <see cref="char"/> array value will be encoded using the <see cref="Encoding.UTF8"/> encoding.</remarks>
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="Base58"/> instance.</param>
    /// <returns>Returns a new <see cref="Base58"/> instance from the specified <see cref="char"/> array value.</returns>
