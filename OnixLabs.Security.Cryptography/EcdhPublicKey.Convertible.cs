...
public sealed partial class EcdhPublicKey
{
    ...
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="EcdhPublicKey"/> instance.</param>
    /// <returns>Returns a new <see cref="EcdhPublicKey"/> instance from the specified <see cref="ReadOnlyMemory{T}"/> value.</returns>
    public static implicit operator EcdhPublicKey(ReadOnlyMemory<byte> value) => new(value);
