...
{
    /// <summary>
    /// Creates a new <see cref="RsaPublicKey"/> instance from the specified <see cref="ReadOnlySpan{T}"/> value.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="RsaPublicKey"/> instance from the specified <see cref="ReadOnlyMemory{T}"/> value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="RsaPublicKey"/> instance.</param>
    /// <returns>Returns a new <see cref="RsaPublicKey"/> instance from the specified <see cref="ReadOnlyMemory{T}"/> value.</returns>
    public static implicit operator RsaPublicKey(ReadOnlyMemory<byte> value) => new(value);

    /// <summary>
    /// Creates a new <see cref="RsaPublicKey"/> instance from the specified <see cref="ReadOnlySequence{T}"/> value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="RsaPublicKey"/> instance.</param>
