...
{
    /// <summary>
    /// Computes an approximation of the reciprocal of the specified <see cref="Float128"/> value.
    /// </summary>
    ...
    public static Float128 ReciprocalEstimate(Float128 value) => One / value;
