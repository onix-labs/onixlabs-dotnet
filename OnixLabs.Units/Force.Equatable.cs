...
{
    /// <inheritdoc/>
    public static bool Equals(Force<T> left, Force<T> right) => left.QuectoNewtons == right.QuectoNewtons;
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(QuectoNewtons);
}
