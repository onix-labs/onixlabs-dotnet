...
public readonly partial struct BigDecimal
{
    ...
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="BigInteger"/> value.</returns>
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="sbyte"/> value.</returns>
    public static explicit operator sbyte(BigDecimal value)
    {
        CheckIntegerOverflow(value, sbyte.MinValue, sbyte.MaxValue);
        return (sbyte)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="byte"/> value.</returns>
    public static explicit operator byte(BigDecimal value)
    {
        CheckIntegerOverflow(value, byte.MinValue, byte.MaxValue);
        return (byte)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="short"/> value.</returns>
    public static explicit operator short(BigDecimal value)
    {
        CheckIntegerOverflow(value, short.MinValue, short.MaxValue);
        return (short)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="ushort"/> value.</returns>
    public static explicit operator ushort(BigDecimal value)
    {
        CheckIntegerOverflow(value, ushort.MinValue, ushort.MaxValue);
        return (ushort)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="int"/> value.</returns>
    public static explicit operator int(BigDecimal value)
    {
        CheckIntegerOverflow(value, int.MinValue, int.MaxValue);
        return (int)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="uint"/> value.</returns>
    public static explicit operator uint(BigDecimal value)
    {
        CheckIntegerOverflow(value, uint.MinValue, uint.MaxValue);
        return (uint)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="long"/> value.</returns>
    public static explicit operator long(BigDecimal value)
    {
        CheckIntegerOverflow(value, long.MinValue, long.MaxValue);
        return (long)value.IntegralValue;
    }
    ...
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="ulong"/> value.</returns>
    public static explicit operator ulong(BigDecimal value)
    {
        CheckIntegerOverflow(value, ulong.MinValue, ulong.MaxValue);
        return (ulong)value.IntegralValue;
    }

    /// <summary>
    /// Converts the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="float"/> value.
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="float"/> value.</returns>
    public static explicit operator float(BigDecimal value)
    {
        throw new NotImplementedException();
        // TODO : return (float)this;
    }

    /// <summary>
    /// Converts the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="double"/> value.
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="double"/> value.</returns>
    public static explicit operator double(BigDecimal value)
    {
        throw new NotImplementedException();
        // TODO : return (double)this;
    }

    /// <summary>
    /// Converts the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="decimal"/> value.
    /// </summary>
    /// <param name="value">The <see cref="BigDecimal"/> value to convert.</param>
    /// <returns>Returns the integral value of the specified <see cref="BigDecimal"/> value to a <see cref="decimal"/> value.</returns>
    public static explicit operator decimal(BigDecimal value)
    {
        throw new NotImplementedException();
        // TODO : return (decimal)this;
    }
    ...
    private static void CheckIntegerOverflow<T>(BigDecimal value, T min, T max) where T : IBinaryInteger<T>
    {
        ...
        if (value.IntegralValue < checkedMin || value.IntegralValue > checkedMax)
        {
