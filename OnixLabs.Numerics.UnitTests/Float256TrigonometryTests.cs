...
public sealed class Float256TrigonometryTests
{
    ...
    {
        Assert.Equal(Float256.Zero.RawHighBits, Float256.Sin(Float256.Zero).RawHighBits);
        Assert.Equal(Float256.Zero.RawLowBits, Float256.Sin(Float256.Zero).RawLowBits);
        Assert.Equal(Float256.NegativeZero.RawHighBits, Float256.Sin(Float256.NegativeZero).RawHighBits);
        Assert.Equal(Float256.NegativeZero.RawLowBits, Float256.Sin(Float256.NegativeZero).RawLowBits);
    }
    ...
    {
        Assert.Equal(Float256.Zero.RawHighBits, Float256.Tan(Float256.Zero).RawHighBits);
        Assert.Equal(Float256.Zero.RawLowBits, Float256.Tan(Float256.Zero).RawLowBits);
        Assert.Equal(Float256.NegativeZero.RawHighBits, Float256.Tan(Float256.NegativeZero).RawHighBits);
        Assert.Equal(Float256.NegativeZero.RawLowBits, Float256.Tan(Float256.NegativeZero).RawLowBits);
    }
    ...
    {
        Assert.Equal(Float256.Zero.RawHighBits, Float256.SinPi(Float256.Zero).RawHighBits);
        Assert.Equal(Float256.Zero.RawLowBits, Float256.SinPi(Float256.Zero).RawLowBits);
