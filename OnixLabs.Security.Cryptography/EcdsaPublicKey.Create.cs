...
public sealed partial class EcdsaPublicKey
{
    ...
    public static EcdsaPublicKey Create(byte[] key, HashAlgorithmType type)
    {
        return new EcdsaPublicKey(key.Copy(), type);
    }
    ...
    /// <param name="type">The <see cref="HashAlgorithmType"/> for computing signature data.</param>
    /// <returns>Returns an <see cref="EcdsaPublicKey"/> from the specified key data and hash algorithm type.</returns>
    public static EcdsaPublicKey Create(Base16 key, HashAlgorithmType type)
    {
    ...
    /// <param name="type">The <see cref="HashAlgorithmType"/> for computing signature data.</param>
    /// <returns>Returns an <see cref="EcdsaPublicKey"/> from the specified key data and hash algorithm type.</returns>
    public static EcdsaPublicKey Create(Base32 key, HashAlgorithmType type)
    {
        byte[] bytes = key.ToByteArray();
        return Create(bytes, type);
    }
    ...
    /// <param name="type">The <see cref="HashAlgorithmType"/> for computing signature data.</param>
    /// <returns>Returns an <see cref="EcdsaPublicKey"/> from the specified key data and hash algorithm type.</returns>
    public static EcdsaPublicKey Create(Base58 key, HashAlgorithmType type)
    {
        byte[] bytes = key.ToByteArray();
        return Create(bytes, type);
    }
    ...
    /// <param name="type">The <see cref="HashAlgorithmType"/> for computing signature data.</param>
    /// <returns>Returns an <see cref="EcdsaPublicKey"/> from the specified key data and hash algorithm type.</returns>
    public static EcdsaPublicKey Create(Base64 key, HashAlgorithmType type)
    {
        byte[] bytes = key.ToByteArray();
        return Create(bytes, type);
    }
