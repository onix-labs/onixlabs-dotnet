...
{
    /// <inheritdoc/>
    public override string ToString() => ToString(QuectoSteradiansSpecifier);
    ...
    {
        (string specifier, int scale) = format.GetSpecifierAndScale(defaultSpecifier: QuectoSteradiansSpecifier);
