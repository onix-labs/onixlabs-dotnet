...
{
    /// <inheritdoc/>
    public static bool Equals(Density<T> left, Density<T> right)
    {
    ...
    /// <inheritdoc/>
    public bool Equals(Density<T> other) => Equals(this, other);

    /// <inheritdoc/>
    public override bool Equals([NotNullWhen(true)] object? obj) => obj is Density<T> other && Equals(other);
