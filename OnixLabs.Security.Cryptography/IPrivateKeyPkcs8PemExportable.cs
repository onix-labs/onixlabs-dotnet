...
/// <summary>
/// Defines a cryptographic private key that can be exported in PKCS #8 RFC 7468 PEM form.
/// </summary>
public interface IPrivateKeyPkcs8PemExportable
{
    /// <summary>
    ...
    /// <summary>
    /// Exports the cryptographic private key data in encrypted PKCS #8 RFC 7468 PEM format.
    /// </summary>
