...
public readonly partial struct Hash
{
    ...
    {
        return Create(value, HashAlgorithmType.Unknown);
    }
    ...
    /// <returns>A new <see cref="Hash"/> instance.</returns>
    public static Hash Create(byte[] value, HashAlgorithmType type)
    {
        return new Hash(value.Copy(), type);
    }
    ...
    public static Hash Create(Base16 value)
    {
    ...
    public static Hash Create(Base32 value)
    {
        byte[] bytes = value.ToByteArray();
        return Create(bytes);
    }
    ...
    public static Hash Create(Base58 value)
    {
        byte[] bytes = value.ToByteArray();
        return Create(bytes);
    }
    ...
    public static Hash Create(Base64 value)
    {
        byte[] bytes = value.ToByteArray();
        return Create(bytes);
    }
