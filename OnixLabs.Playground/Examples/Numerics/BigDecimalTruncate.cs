...
[Title("BigDecimal.Truncate vs Math.Truncate")]
public sealed class BigDecimalTruncate : Example
{
    public override void Execute()
    {
        ...
        {
            decimal expected = Math.Truncate(value);
            BigDecimal actual = BigDecimal.Truncate(new BigDecimal(value));
            ...
            string[] table =
            {
                $"BigDecimal.Truncate({value})".PadRight(32),
