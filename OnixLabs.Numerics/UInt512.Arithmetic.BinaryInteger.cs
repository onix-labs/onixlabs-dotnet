...
{
    /// <summary>Returns the number of leading zero bits in the specified <see cref="UInt512"/> value.</summary>
    ...
    {
        if (!UInt256.IsZero(value.UpperBits)) return new UInt512(UInt256.Zero, UInt256.LeadingZeroCount(value.UpperBits));
        return new UInt512(UInt256.Zero, (UInt256)HalfBitWidth + UInt256.LeadingZeroCount(value.LowerBits));
    }
    ...
    {
        if (!UInt256.IsZero(value.LowerBits)) return new UInt512(UInt256.Zero, UInt256.TrailingZeroCount(value.LowerBits));
        if (!UInt256.IsZero(value.UpperBits)) return new UInt512(UInt256.Zero, (UInt256)HalfBitWidth + UInt256.TrailingZeroCount(value.UpperBits));
    ...
    public static UInt512 PopCount(UInt512 value) => new(UInt256.Zero, UInt256.PopCount(value.UpperBits) + UInt256.PopCount(value.LowerBits));
    ...
    public static UInt512 Log2(UInt512 value)
    {
        ...
        if (!UInt256.IsZero(value.UpperBits)) return new UInt512(UInt256.Zero, (UInt256)HalfBitWidth + UInt256.Log2(value.UpperBits));
        return new UInt512(UInt256.Zero, UInt256.Log2(value.LowerBits));
    }
    ...
    /// <summary>Rotates the specified <see cref="UInt512"/> value right by the specified number of bits.</summary>
    /// <param name="value">The value to rotate.</param>
    /// <param name="rotateAmount">The number of bits to rotate by.</param>
