...
{
    /// <summary>
    /// Gets the underlying <see cref="T:Byte[]"/> representation of the current <see cref="Base32"/> instance as a new <see cref="ReadOnlyMemory{T}"/> instance.
    /// </summary>
    /// <returns>Return the underlying <see cref="T:Byte[]"/> representation of the current <see cref="Base32"/> instance as a new <see cref="ReadOnlyMemory{T}"/> instance.</returns>
    ...
    /// <summary>
    /// Create a new <see cref="Base32"/> instance from the specified <see cref="T:byte[]"/> value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="Base32"/> instance.</param>
    /// <returns>Returns a new <see cref="Base32"/> instance from the specified <see cref="T:byte[]"/> value.</returns>
