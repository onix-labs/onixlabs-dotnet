...
public readonly partial struct DigitalSignature
{
    ...
    public bool Equals(DigitalSignature other) => value.NullSafeSequenceEqual(other.value);
    ...
    public static bool operator ==(DigitalSignature left, DigitalSignature right) => Equals(left, right);
