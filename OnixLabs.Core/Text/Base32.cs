...
public readonly partial struct Base32 : IBaseValue<Base32>
{
    ...
    /// </remarks>
    /// <param name="value">The value with which to initialize the new <see cref="Base32"/> instance.</param>
    ...
    public Base32(ReadOnlySpan<char> value, Encoding? encoding = null) : this(encoding.GetOrDefault().GetBytes(value))
    {
    }
