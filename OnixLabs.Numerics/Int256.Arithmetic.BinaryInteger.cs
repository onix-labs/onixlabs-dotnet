...
{
    /// <summary>Returns the number of leading zero bits in the specified <see cref="Int256"/> value.</summary>
    ...
    /// <summary>Rotates the specified <see cref="Int256"/> value right by the specified number of bits.</summary>
    /// <param name="value">The value to rotate.</param>
    /// <param name="rotateAmount">The number of bits to rotate by.</param>
