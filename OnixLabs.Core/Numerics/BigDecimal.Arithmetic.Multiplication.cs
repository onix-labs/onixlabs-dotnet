...
public readonly partial struct BigDecimal
{
    ...
    /// <summary>
    /// Computes the product of the current <see cref="BigDecimal"/> value and the specified value.
    /// </summary>
    /// <param name="right">The right-hand value to multiply.</param>
    /// <returns>Returns the product of the current <see cref="BigDecimal"/> value and the specified value.</returns>
