...
{
    /// <inheritdoc/>
    public static RsaPrivateKey Parse(string value, IFormatProvider? provider = null) =>
        Parse(value.AsSpan(), provider);

    /// <inheritdoc/>
    public static RsaPrivateKey Parse(ReadOnlySpan<char> value, IFormatProvider? provider = null) =>
        RsaPrivateKey.ParseOrThrow(value, provider);

    /// <inheritdoc/>
    public static bool TryParse(string? value, IFormatProvider? provider, out RsaPrivateKey result) =>
