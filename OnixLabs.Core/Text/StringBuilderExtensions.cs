...
public static class StringBuilderExtensions
{
    ...
    public static StringBuilder Append(this StringBuilder builder, params object[] values) => builder
        .Append(values.JoinToString(string.Empty));
    ...
    public static StringBuilder Prepend(this StringBuilder builder, params object[] values) => builder
        .Insert(0, values.JoinToString(string.Empty));
    ...
    public static StringBuilder Trim(this StringBuilder builder, char value) => builder
