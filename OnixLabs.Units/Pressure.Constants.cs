...
{
    /// <inheritdoc/>
    public static Pressure<T> Zero => new(T.Zero);
    ...
    private const string BarSpecifier = "bar";
    private const string MillibarSpecifier = "mbar";
    ...
    private const string KilopoundsPerSquareInchSpecifier = "ksi";
    private const string TechnicalAtmospheresSpecifier = "at";
    private const string BaryesSpecifier = "Ba";
}
