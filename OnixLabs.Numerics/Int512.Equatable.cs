...
{
    /// <summary>Compares two instances of <see cref="Int512"/> to determine whether their values are equal.</summary>
    ...
    public bool Equals(Int512 other) => Equals(this, other);
    ...
    public override bool Equals(object? obj) => obj is Int512 other && Equals(other);
    ...
    public static bool operator ==(Int512 left, Int512 right) => Equals(left, right);
