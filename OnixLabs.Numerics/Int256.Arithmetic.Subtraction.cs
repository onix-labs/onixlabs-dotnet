...
{
    /// <summary>Computes the difference of two <see cref="Int256"/> values, wrapping on overflow.</summary>
    ...
    /// <summary>Computes the difference of two <see cref="Int256"/> values, throwing on overflow.</summary>
    /// <param name="left">The minuend.</param>
    /// <param name="right">The subtrahend.</param>
    /// <returns>Returns the difference.</returns>
    /// <exception cref="OverflowException">Thrown when the difference overflows the range of <see cref="Int256"/>.</exception>
