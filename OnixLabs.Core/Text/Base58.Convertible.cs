...
public readonly partial struct Base58
{
    ...
    /// <summary>
    /// Creates a new <see cref="Base58"/> instance from the specified <see cref="ReadOnlySpan{T}"/> value.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Base58"/> instance from the specified <see cref="ReadOnlySequence{T}"/> value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="Base58"/> instance.</param>
    ...
    /// <param name="value">The value from which to create a new <see cref="Base58"/> instance.</param>
    /// <returns>Returns a new <see cref="Base58"/> instance from the specified <see cref="ReadOnlySpan{T}"/> value.</returns>
    public static implicit operator Base58(ReadOnlySpan<char> value) => new(value);
