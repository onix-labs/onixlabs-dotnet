...
{
    /// <summary>
    /// Computes the smallest integral <see cref="Float128"/> value that is greater than or equal to the specified value.
    /// </summary>
    /// <param name="value">The <see cref="Float128"/> value to ceiling.</param>
    /// <returns>Returns the ceiling of <paramref name="value"/>; NaN, ±infinity and ±zero are returned unchanged.</returns>
    public static Float128 Ceiling(Float128 value)
    {
        ...
        return new Float128(incrementedAbsolute);
    }
}
