...
/// <summary>
/// Defines a cryptographic public key that can be imported from RFC 7468 PEM-encoded data.
/// </summary>
/// <typeparam name="T">The underlying type of <see cref="PublicKey"/> that the import functions will return.</typeparam>
public interface IPublicKeyPemImportable<out T> where T : PublicKey
{
    /// <summary>
    /// Imports the cryptographic public key data from RFC 7468 PEM-encoded text. The PEM label
    /// determines the format that is decoded (typically <c>PUBLIC KEY</c>, that is, SPKI).
    /// </summary>
    ...
    /// <summary>
    /// Imports the cryptographic public key data from encrypted RFC 7468 PEM-encoded text.
    /// </summary>
    /// <param name="data">The cryptographic public key data to import.</param>
