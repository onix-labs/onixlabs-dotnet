...
/// <summary>
/// Provides extension methods for <see cref="HashAlgorithm"/> instances.
/// </summary>
...
public static class HashAlgorithmExtensions
{
    ...
    /// Provides extension methods for <see cref="HashAlgorithm"/> instances.
    /// </summary>
    /// <param name="algorithm">The current <see cref="HashAlgorithm"/> instance.</param>
    extension(HashAlgorithm algorithm)
    {
        /// <summary>
        ...
        /// <summary>
        /// Attempts to compute the hash value for the specified <see cref="ReadOnlySpan{T}"/> instance.
        /// </summary>
        ...
        public bool TryComputeHash(ReadOnlySpan<byte> source, Span<byte> destination, int offset, int count, int rounds, out int bytesWritten)
        {
            try
            {
