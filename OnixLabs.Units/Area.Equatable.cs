...
{
    /// <inheritdoc/>
    public static bool Equals(Area<T> left, Area<T> right) => left.SquareQuectoMeters == right.SquareQuectoMeters;
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(SquareQuectoMeters);
}
