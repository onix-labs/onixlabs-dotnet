...
{
    /// <summary>Computes the natural (base-<see cref="E"/>) logarithm of the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value for which to compute the natural logarithm.</param>
    /// <returns>Returns the natural logarithm of <paramref name="value"/>.</returns>
    ...
    /// <summary>Computes the base-2 logarithm of the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value for which to compute the base-2 logarithm.</param>
    /// <returns>Returns the base-2 logarithm of <paramref name="value"/>.</returns>
    ...
    /// <summary>Computes the base-10 logarithm of the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value for which to compute the base-10 logarithm.</param>
    /// <returns>Returns the base-10 logarithm of <paramref name="value"/>.</returns>
    ...
    /// <summary>Computes the natural logarithm of one plus the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value to add to one before computing the natural logarithm.</param>
    /// <returns>Returns the natural logarithm of <c>1 + value</c>.</returns>
    ...
    /// <summary>Computes the base-2 logarithm of one plus the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value to add to one before computing the base-2 logarithm.</param>
    /// <returns>Returns the base-2 logarithm of <c>1 + value</c>.</returns>
    ...
    /// <summary>Computes the base-10 logarithm of one plus the specified <see cref="Float256"/> value.</summary>
    /// <param name="value">The value to add to one before computing the base-10 logarithm.</param>
    /// <returns>Returns the base-10 logarithm of <c>1 + value</c>.</returns>
    ...
    private static Float256 LogCore(Float256 value)
    {
        int e = ILogB(value);
    ...
    private static Float256 Log1pCore(Float256 value)
    {
    ...
    private static Float256 AtanhSeries(Float256 u)
    {
        Float256 sum = u;
        Float256 term = u;
