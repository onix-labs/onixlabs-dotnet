...
public static class NumericsExtensions
{
    ...
    public static BigDecimal ToBigDecimal<T>(this T value, int scale = default, ScaleMode mode = ScaleMode.Integral) where T : IBinaryInteger<T> => new(value.ToBigInteger(), scale, mode);
