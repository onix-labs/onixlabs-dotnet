...
{
    /// <summary>Decrements the specified <see cref="Int512"/> value by one.</summary>
    ...
    /// <summary>Decrements the specified <see cref="Int512"/> value by one, throwing on underflow.</summary>
    /// <param name="value">The value to decrement.</param>
