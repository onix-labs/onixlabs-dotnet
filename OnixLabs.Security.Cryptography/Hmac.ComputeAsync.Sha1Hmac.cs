...
namespace OnixLabs.Security.Cryptography
{
    public readonly partial struct Hmac
    {
        ...
        public static async Task<Hmac> ComputeSha1HmacAsync(string value, string key)
        {
            return await ComputeSha1HmacAsync(value, key, Encoding.Default);
        }
        ...
        /// <returns>Returns a <see cref="Hmac"/> of the input value and key.</returns>
        public static async Task<Hmac> ComputeSha1HmacAsync(string value, string key, Encoding encoding)
        {
        ...
        /// <param name="key">The key for which to compute a HMAC.</param>
        /// <returns>Returns a <see cref="Hmac"/> of the input value and key.</returns>
        public static async Task<Hmac> ComputeSha1HmacAsync(byte[] value, byte[] key)
        {
            return await ComputeHmacAsync(value, key, HashAlgorithmType.Sha1Hmac);
        }
    }
}
