...
{
    /// <summary>Returns the string representation of the current <see cref="UInt256"/> value using the default format and culture.</summary>
    /// <returns>Returns the string representation of the current value.</returns>
    public override string ToString() => ToString(null, CultureInfo.CurrentCulture);

    /// <summary>Returns the string representation of the current <see cref="UInt256"/> value using the specified format.</summary>
    /// <param name="format">The format to use, or <see langword="null"/> for default.</param>
    /// <returns>Returns the string representation of the current value.</returns>
    public string ToString(string? format) => ToString(format, CultureInfo.CurrentCulture);

    /// <summary>Returns the string representation of the current <see cref="UInt256"/> value using the specified format and provider.</summary>
    /// <param name="format">The format to use, or <see langword="null"/> for default.</param>
