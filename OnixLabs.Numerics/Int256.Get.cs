...
public readonly partial struct Int256
{
    ...
    public int GetShortestBitLength()
    {
        if (IsNegative(this))
        {
            UInt128 invertedUpper = ~UpperBits;
            UInt128 invertedLower = ~LowerBits;
    ...
    int IBinaryInteger<Int256>.GetByteCount() => GetByteCount();

    /// <inheritdoc cref="IBinaryInteger{TSelf}.GetShortestBitLength"/>
    int IBinaryInteger<Int256>.GetShortestBitLength() => GetShortestBitLength();
}
