...
{
    /// <inheritdoc/>
    /// <remarks>Non-zero denominator (1 C = 1 A · 1 s) avoids 0/0 = NaN; numerator zero gives a genuine zero magnitude.</remarks>
    public static ElectricPotential<T> Zero => new(
        Energy<T>.Zero,
