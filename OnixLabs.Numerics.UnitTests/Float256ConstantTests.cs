...
public sealed class Float256ConstantTests
{
    ...
    public void Float256ZeroShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(UInt128.Zero, value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256NegativeZeroShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x8000_0000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256OneShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x3FFF_F000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256NegativeOneShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0xBFFF_F000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256TwoShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x4000_0000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256TenShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x4000_2400_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256MaxValueShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x7FFF_EFFF_FFFF_FFFFUL, 0xFFFF_FFFF_FFFF_FFFFUL), value.RawHighBits);
        Assert.Equal(new UInt128(0xFFFF_FFFF_FFFF_FFFFUL, 0xFFFF_FFFF_FFFF_FFFFUL), value.RawLowBits);
    }
    ...
    public void Float256MinValueShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0xFFFF_EFFF_FFFF_FFFFUL, 0xFFFF_FFFF_FFFF_FFFFUL), value.RawHighBits);
        Assert.Equal(new UInt128(0xFFFF_FFFF_FFFF_FFFFUL, 0xFFFF_FFFF_FFFF_FFFFUL), value.RawLowBits);
    }
    ...
    public void Float256EpsilonShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(UInt128.Zero, value.RawHighBits);
        Assert.Equal(UInt128.One, value.RawLowBits);
    }
    ...
    public void Float256PositiveInfinityShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x7FFF_F000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256NegativeInfinityShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0xFFFF_F000_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
    ...
    public void Float256NaNShouldProduceExpectedResult()
    {
        ...
        // Then
        Assert.Equal(new UInt128(0x7FFF_F800_0000_0000UL, 0UL), value.RawHighBits);
        Assert.Equal(UInt128.Zero, value.RawLowBits);
    }
}
