...
public sealed class UInt512EquatableTests
{
    ...
    [Fact(DisplayName = "UInt512.GetHashCode should not collide for power-of-two pairs that are 32 bits apart (regression for ulong.GetHashCode XOR loss)")]
    public void UInt512GetHashCodeShouldNotCollideForPowerOfTwoPairsAcross32BitBoundary()
    {
        ...
        {
            UInt512 small = UInt512.One << shift;
            UInt512 large = UInt512.One << (shift + 32);
