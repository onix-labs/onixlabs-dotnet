...
public sealed class HashTests
{
    ...
    {
        // Arrange
        Hash a = Hash.FromByteArray(Collection.ArrayOf<byte>(1));
        Hash b = Hash.FromByteArray(Collection.ArrayOf<byte>(2));
    ...
    {
        // Arrange
        Hash a = Hash.FromByteArray(Collection.ArrayOf<byte>(2));
        Hash b = Hash.FromByteArray(Collection.ArrayOf<byte>(1));
        const int expected = 1;
