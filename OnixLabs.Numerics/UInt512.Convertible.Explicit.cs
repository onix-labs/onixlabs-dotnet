...
{
    /// <summary>Explicitly converts an <see cref="sbyte"/> value to a <see cref="UInt512"/> value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping negatives via two's-complement.</returns>
    public static explicit operator UInt512(sbyte value)
    {
        if (value >= 0) return new UInt512(UInt256.Zero, (byte)value);
        return new UInt512(UInt256.MaxValue, (UInt256)(long)value);
    }

    /// <summary>Explicitly converts an <see cref="sbyte"/> value to a <see cref="UInt512"/> value, throwing on negative input.</summary>
    /// <param name="value">The value to convert.</param>
    ...
    {
        if (value < 0) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return new UInt512(UInt256.Zero, (byte)value);
    }

    /// <summary>Explicitly converts a <see cref="short"/> value to a <see cref="UInt512"/> value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping negatives via two's-complement.</returns>
    public static explicit operator UInt512(short value)
    {
        if (value >= 0) return new UInt512(UInt256.Zero, (ushort)value);
        return new UInt512(UInt256.MaxValue, (UInt256)(long)value);
    }

    /// <summary>Explicitly converts a <see cref="short"/> value to a <see cref="UInt512"/> value, throwing on negative input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    /// <exception cref="OverflowException">Thrown when <paramref name="value"/> is negative.</exception>
    ...
    {
        if (value < 0) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return new UInt512(UInt256.Zero, (ushort)value);
    }

    /// <summary>Explicitly converts an <see cref="int"/> value to a <see cref="UInt512"/> value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping negatives via two's-complement.</returns>
    public static explicit operator UInt512(int value)
    {
        if (value >= 0) return new UInt512(UInt256.Zero, (uint)value);
        return new UInt512(UInt256.MaxValue, (UInt256)(long)value);
    }

    /// <summary>Explicitly converts an <see cref="int"/> value to a <see cref="UInt512"/> value, throwing on negative input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    /// <exception cref="OverflowException">Thrown when <paramref name="value"/> is negative.</exception>
    ...
    {
        if (value < 0) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return new UInt512(UInt256.Zero, (uint)value);
    }

    /// <summary>Explicitly converts a <see cref="long"/> value to a <see cref="UInt512"/> value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping negatives via two's-complement.</returns>
    public static explicit operator UInt512(long value)
    {
        if (value >= 0) return new UInt512(UInt256.Zero, (ulong)value);
        return new UInt512(UInt256.MaxValue, (UInt256)value);
    }

    /// <summary>Explicitly converts a <see cref="long"/> value to a <see cref="UInt512"/> value, throwing on negative input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    /// <exception cref="OverflowException">Thrown when <paramref name="value"/> is negative.</exception>
    ...
    {
        if (value < 0) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return new UInt512(UInt256.Zero, (ulong)value);
    }

    /// <summary>Explicitly converts an <see cref="Int128"/> value to a <see cref="UInt512"/> value.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping negatives via two's-complement.</returns>
    public static explicit operator UInt512(Int128 value)
    {
        if (value >= Int128.Zero) return new UInt512(UInt256.Zero, (UInt128)value);
        return new UInt512(UInt256.MaxValue, (UInt256)value);
    }

    /// <summary>Explicitly converts an <see cref="Int128"/> value to a <see cref="UInt512"/> value, throwing on negative input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    /// <exception cref="OverflowException">Thrown when <paramref name="value"/> is negative.</exception>
    public static explicit operator checked UInt512(Int128 value)
    {
        if (value < Int128.Zero) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return new UInt512(UInt256.Zero, (UInt128)value);
    }

    /// <summary>Explicitly converts a <see cref="BigInteger"/> value to a <see cref="UInt512"/> value, truncating to 512 bits.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the low 512 bits of <paramref name="value"/>.</returns>
    public static explicit operator UInt512(BigInteger value)
    {
        ...
        return BigIntegerToUInt512(truncated);
    }

    /// <summary>Explicitly converts a <see cref="BigInteger"/> value to a <see cref="UInt512"/> value, throwing on overflow.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    ...
    {
        if (value.Sign < 0) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        if (value.GetBitLength() > BitWidth) throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        return BigIntegerToUInt512(value);
    }
    ...
    public static implicit operator BigInteger(UInt512 value) => UInt512ToBigInteger(value);

    /// <summary>Explicitly converts a <see cref="UInt512"/> value to a <see cref="float"/>.</summary>
    /// <param name="value">The value to convert.</param>
    ...
    /// <summary>Explicitly converts a <see cref="UInt512"/> value to a <see cref="double"/>.</summary>
    /// <param name="value">The value to convert.</param>
    ...
    /// <summary>Explicitly converts a <see cref="UInt512"/> value to a <see cref="decimal"/>.</summary>
    /// <param name="value">The value to convert.</param>
    ...
    public static explicit operator decimal(UInt512 value) => (decimal)(BigInteger)value;

    /// <summary>Explicitly converts a <see cref="UInt512"/> value to a <see cref="Float128"/>.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="Float128"/> nearest to <paramref name="value"/>, with rounding to nearest, ties-to-even.</returns>
    public static explicit operator Float128(UInt512 value) => (Float128)(BigDecimal)(BigInteger)value;

    /// <summary>Explicitly converts a <see cref="UInt512"/> value to a <see cref="Float256"/>.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="Float256"/> nearest to <paramref name="value"/>, with rounding to nearest, ties-to-even.</returns>
    public static explicit operator Float256(UInt512 value) => (Float256)(BigDecimal)(BigInteger)value;

    /// <summary>Explicitly converts a <see cref="Float128"/> value to a <see cref="UInt512"/>, truncating toward zero.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the truncated <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping for out-of-range or non-finite inputs.</returns>
    public static explicit operator UInt512(Float128 value)
    {
        ...
        return (UInt512)(BigInteger)(BigDecimal)Float128.Truncate(value);
    }

    /// <summary>Explicitly converts a <see cref="Float128"/> value to a <see cref="UInt512"/>, throwing on overflow or non-finite input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the truncated <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    ...
    public static explicit operator checked UInt512(Float128 value)
    {
        ...
        return checked((UInt512)(BigInteger)(BigDecimal)Float128.Truncate(value));
    }

    /// <summary>Explicitly converts a <see cref="Float256"/> value to a <see cref="UInt512"/>, truncating toward zero.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the truncated <see cref="UInt512"/> representation of <paramref name="value"/>, wrapping for out-of-range or non-finite inputs.</returns>
    public static explicit operator UInt512(Float256 value)
    {
        ...
        return (UInt512)(BigInteger)(BigDecimal)Float256.Truncate(value);
    }

    /// <summary>Explicitly converts a <see cref="Float256"/> value to a <see cref="UInt512"/>, throwing on overflow or non-finite input.</summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the truncated <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    /// <exception cref="OverflowException">Thrown when <paramref name="value"/> is NaN, infinite, negative, or exceeds <see cref="MaxValue"/>.</exception>
    public static explicit operator checked UInt512(Float256 value)
    {
        if (Float256.IsNaN(value) || Float256.IsInfinity(value) || Float256.IsNegative(value))
        {
            throw new OverflowException($"Value was either too large or too small for the specified type: {nameof(UInt512)}.");
        }
        return checked((UInt512)(BigInteger)(BigDecimal)Float256.Truncate(value));
    }

    /// <summary>
    /// Converts a non-negative <see cref="BigInteger"/> to a <see cref="UInt512"/> by accumulating its 64-bit chunks.
    /// </summary>
    /// <param name="value">The value to convert; expected to be non-negative and to fit within <see cref="BitWidth"/> bits.</param>
    /// <returns>Returns the <see cref="UInt512"/> representation of <paramref name="value"/>.</returns>
    internal static UInt512 BigIntegerToUInt512(BigInteger value)
    {
        UInt512 result = Zero;
        ...
        for (int shift = 0; shift < BitWidth && !remainingBits.IsZero; shift += 64)
        {
            ...
            if (chunk != 0UL)
            {
                UInt512 contribution = new UInt512(UInt256.Zero, (UInt256)(UInt128)chunk) << shift;
    ...
    /// <summary>
    /// Converts a <see cref="UInt512"/> to a non-negative <see cref="BigInteger"/> by combining its upper and lower halves.
    /// </summary>
    /// <param name="value">The value to convert.</param>
    /// <returns>Returns the <see cref="BigInteger"/> representation of <paramref name="value"/>.</returns>
