...
public sealed class Float256ExponentialTests
{
    ...
    {
        Assert.Equal(Float256.Zero.Bits.UpperBits, Float256.ExpM1(Float256.Zero).Bits.UpperBits);
        Assert.Equal(Float256.Zero.Bits.LowerBits, Float256.ExpM1(Float256.Zero).Bits.LowerBits);
        Assert.Equal(Float256.NegativeZero.Bits.UpperBits, Float256.ExpM1(Float256.NegativeZero).Bits.UpperBits);
        Assert.Equal(Float256.NegativeZero.Bits.LowerBits, Float256.ExpM1(Float256.NegativeZero).Bits.LowerBits);
    }
