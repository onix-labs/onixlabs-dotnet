...
public static partial class Collection
{
    ...
    public static Dictionary<TKey, TValue> DictionaryOf<TKey, TValue>(params (TKey key, TValue value)[] items) where TKey : notnull =>
        DictionaryOf(items.Select(item => new KeyValuePair<TKey, TValue>(item.key, item.value)).ToArray());
    ...
    public static ImmutableDictionary<TKey, TValue> ImmutableDictionaryOf<TKey, TValue>(params KeyValuePair<TKey, TValue>[] items) where TKey : notnull =>
    ...
    /// <typeparam name="TValue">The underlying type of the immutable dictionary value.</typeparam>
    /// <returns>Returns an immutable dictionary populated with the specified items.</returns>
    public static ImmutableDictionary<TKey, TValue> ImmutableDictionaryOf<TKey, TValue>(params (TKey key, TValue value)[] items) where TKey : notnull =>
    ...
    public static SortedDictionary<TKey, TValue> SortedDictionaryOf<TKey, TValue>(params KeyValuePair<TKey, TValue>[] items) where TKey : notnull =>
        new(DictionaryOf(items));
    ...
    /// <typeparam name="TValue">The underlying type of the sorted dictionary value.</typeparam>
    /// <returns>Returns a sorted dictionary populated with the specified items.</returns>
    public static SortedDictionary<TKey, TValue> SortedDictionaryOf<TKey, TValue>(params (TKey key, TValue value)[] items) where TKey : notnull =>
        new(DictionaryOf(items));
    ...
    public static ImmutableSortedDictionary<TKey, TValue> ImmutableSortedDictionaryOf<TKey, TValue>(params KeyValuePair<TKey, TValue>[] items) where TKey : notnull =>
        ImmutableSortedDictionary.CreateRange(items);
    ...
    /// <typeparam name="TValue">The underlying type of the immutable sorted dictionary value.</typeparam>
    /// <returns>Returns an immutable sorted dictionary populated with the specified items.</returns>
    public static ImmutableSortedDictionary<TKey, TValue> ImmutableSortedDictionaryOf<TKey, TValue>(params (TKey key, TValue value)[] items) where TKey : notnull =>
