...
{
    /// <summary>
    /// Gets the ECDSA cryptographic public key component from the current cryptographic private key.
    /// </summary>
    /// <returns>Returns the ECDSA cryptographic public key component from the current cryptographic private key.</returns>
    ...
    DigitalSignature SignData(ReadOnlySpan<byte> data, HashAlgorithm algorithm, DSASignatureFormat format = default);
    ...
    /// <param name="format">The signature format to use when signing the specified unsigned data.</param>
    /// <returns>Returns a cryptographic <see cref="DigitalSignature"/> of the hashed and signed data.</returns>
    DigitalSignature SignData(ReadOnlySpan<byte> data, int offset, int count, HashAlgorithm algorithm, DSASignatureFormat format = default);
    ...
    /// <param name="format">The signature format to use when signing the specified unsigned data.</param>
    /// <returns>Returns a cryptographic <see cref="DigitalSignature"/> of the hashed and signed data.</returns>
    DigitalSignature SignData(IBinaryConvertible data, HashAlgorithm algorithm, DSASignatureFormat format = default);
    ...
    /// <param name="format">The signature format to use when signing the specified unsigned data.</param>
    /// <returns>Returns a cryptographic <see cref="DigitalSignature"/> of the hashed and signed data.</returns>
    DigitalSignature SignData(Stream data, HashAlgorithm algorithm, DSASignatureFormat format = default);
    ...
    DigitalSignature SignHash(Hash hash, DSASignatureFormat format = default);
    ...
    /// <param name="format">The signature format to use when signing the specified unsigned data.</param>
    /// <returns>Returns a cryptographic <see cref="DigitalSignature"/> of the signed hash.</returns>
    DigitalSignature SignHash(ReadOnlySpan<byte> hash, DSASignatureFormat format = default);
}
