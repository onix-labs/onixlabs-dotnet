...
{
    /// <summary>
    /// Create a new <see cref="RsaPublicKey"/> instance from the specified <see cref="T:byte[]"/> value.
    /// </summary>
    /// <param name="value">The value from which to create a new <see cref="RsaPublicKey"/> instance.</param>
    /// <returns>Returns a new <see cref="RsaPublicKey"/> instance from the specified <see cref="T:byte[]"/> value.</returns>
    public static implicit operator RsaPublicKey(byte[] value) => new(value);
