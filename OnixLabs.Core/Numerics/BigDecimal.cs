...
public readonly partial struct BigDecimal
{
    ...
    /// <summary>
    /// Gets the precision of the current <see cref="BigDecimal"/> value.
    /// </summary>
    ...
    /// <summary>
    /// Gets the absolute, fractional value of the current <see cref="BigDecimal"/> value.
    /// </summary>
    public BigInteger AbsoluteFractionalValue => BigInteger.Abs(UnscaledValue) - AbsoluteIntegralValue * Magnitude;

    /// <summary>
    /// Gets the magnitude of the current <see cref="BigDecimal"/>, which is 10 raised to the power of its scale.
    /// </summary>
    private BigInteger Magnitude => BigInteger.Pow(Ten.UnscaledValue, Scale);
}
